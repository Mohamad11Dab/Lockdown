...
# assess your code.
#
# The following function creates a random data set defining the overall
# image to draw.  Your program must work for ANY data set that can be
# produced by this function.  The results returned by calling this
# function will be used as the argument to your data visualisation
# function during marking.  For convenience during code development and
# marking this function also prints the data set generated to the shell
# window.  NB: Your solution should not print anything else to the
# shell.  Make sure any debugging calls to the "print" function are
# disabled before you submit your solution.
